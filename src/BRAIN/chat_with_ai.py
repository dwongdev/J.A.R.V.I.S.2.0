...
# EMBEDDING_MODEL = load_variable("Embedding_model")
...
# def store_important_chat(prompt: str, response: str , threshold=80):
...
# def distance_to_similarity_inverted(distance, scale=1.0):
...
#         similarity_score = distance_to_similarity_inverted(score)
...
#     # system_prompt = """
#     #     You are an AI that keeps track of the context of previous conversations. If a user provides personal information, remember and incorporate that in your responses.
#     #     When responding, try to directly refer to or acknowledge the details provided in previous messages, especially personal details, and ensure the conversation is fluid and coherent."""
...
#         llm = ChatOllama(model=AI_MODEL, temperature=0, max_token=max_token)
